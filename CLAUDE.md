...
## ภาษา
- **ตอบกลับผู้ใช้เป็นภาษาไทยเสมอ** ทั้งคำอธิบาย สรุป และข้อความในแชต (ไม่ต้องรอให้สั่ง)
- โค้ด ชื่อไฟล์ ชื่อตัวแปร คำสั่ง git/PR และ commit message ยังคงเป็นภาษาอังกฤษตามปกติ
